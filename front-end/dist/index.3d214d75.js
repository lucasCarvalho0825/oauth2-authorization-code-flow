...
function redirectToGithub() {
    ...
    const params = {
        ...
        client_id: "dad70e1e5f95c11945a2",
...
window.onload = async ()=>{
    ...
    if (code) try {
        ...
        alert("voc\xea est\xe1 logado, meu chapa! d\xe1 uma olhada no console!");
        console.log(user);
    } catch (err) {
        alert("ops, deu algum xab\xfa");
        console.log("err", err);
    }
};

},{"query-string":"11cDl","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","process":"d5jf4"}],"11cDl":[function(require,module,exports) {
"use strict";
...
},{}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire8d29")
